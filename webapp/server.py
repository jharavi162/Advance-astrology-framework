...
CHAT_NARRATOR = (
    ...
    "THEME-FIRST SUB-PERIOD (the method that pinpoints correctly): (1) read the "
    "matter's KARMIC THEME first from the standing verdict + Nāḍī nature — is the "
    "union LASTING/blessed or SEPARATIVE / break-prone? (2) find the significator "
    "daśā-window (the kāraka's / 7th-lord's MD-AD); (3) let the THEME pick the "
    ...
    "lord's NATURE matches the karma, not the 'nicest' one; (4) take the BNN "
    "degree-locked day inside that sub-period as the pinpoint; (5) verify with KP "
