...
CHAT_NARRATOR = (
    ...
    "significator planets (7th lord, kāraka Venus, planets in/aspecting the 7th, "
    "2nd & 11th lords, and their nakṣatra-lords) and mark the Vimśottari windows "
    "whose MD-AD-PD lords are drawn from that set — the MD (or cusp sub-lord) must "
    "itself signify 2/7/11; a window whose period-lords are NOT significators "
    "cannot carry the event however high it scores; (3) let the THEME pick the "
    ...
    "sub-period (where the SAME significators trine/contact) as the day — TRUST it "
    "over the salience ranking and the call's window; (5) verify with KP "
